    ...
    <div class="col-md-12 my-3">
        <div class="d-flex flex-row flex-md-row flex-sm-column">
            <div class="flex-grow-1 bg-primary me-2 text-center text-white py-3 rounded-3 info-card">
                <span>11:00 PM</span>
                <a href="/2d-3d-lottery-play" class="btn w-100 py-2 fs-2 fw-bold text-warning" type="button" id="">26</a>
            </div>
            <div class="flex-grow-1 bg-primary ms-2 text-center text-white py-3 rounded-3 info-card">
                <span>4:30 PM</span>
                <a href="/2d-3d-lottery-play" class="btn w-100 py-2 fs-2 fw-bold text-warning" type="button" id="">05</a>
            </div>
        </div>
    </div>
    <div class="col-md-12 my-3">
