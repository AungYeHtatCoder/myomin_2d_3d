...
@section('content')
          <!-- Subnav -->
          <div>
            <h4 class="text-center text-white my-3">ငွေသွင်းရန် အချက်လက်များကို မှန်ကန်စွာဖြည့်ပါ။</h4>
            <div class="my-3">
              <form action="{{ route('user.register.form.submit') }}" method="POST">
                ...
                <div class="my-2">
                  <input class="form-control" type="number" name="" placeholder="လုပ်ဆောင်မှုအမှတ်စဉ်(နောက်ဆုံးဂဏန်း ၆ လုံး)">
                </div>
                <div class="my-2">
