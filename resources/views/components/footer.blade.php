          ...
          <div class="list-group d-flex flex-row flex-wrap justify-content-between align-items-center">
            <div class="bg-transparent border-0 col-md-2 mb-3">
              <a href="/"
                ...
                <div>
                  <img src="{{ asset('./assets/img/home.svg') }}" class="img-fluid rounded-top" alt="">
                </div>
                ပင်မ
              </a>
            </div>
            <div class="bg-transparent border-0 col-md-2 mb-3">
              <a href="/promotion"
                class="text-white text-decoration-none d-flex flex-column justify-content-center align-items-center">
                <div>
                  <img src="{{ asset('./assets/img/promotion.svg') }}" class="img-fluid rounded-top" alt="">
                </div>
                ပရိုမိုးရှင်း
              </a>
            </div>
            <div class="bg-transparent border-0 col-md-2 mb-3">
              <a href="/2d-3d-lottery-play"
                class="text-white text-decoration-none d-flex flex-column justify-content-center align-items-center">
                <div>
                  <img src="{{ asset('./assets/img/coupon.svg') }}" class="img-fluid rounded-top" alt="">
                </div>
                ထိုးမည်
              </a>
            </div>
