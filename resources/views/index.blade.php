            ...
            <div id="myCarousel" class="carousel slide z-n1" data-bs-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="{{ asset('./assets/img/photo_2023-11-24_09-44-54.jpg') }}" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                  <img src="{{ asset('./assets/img/photo_2023-11-24_09-45-23.jpg') }}" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                  <img src="{{ asset('./assets/img/photo_2023-11-24_09-45-14.jpg') }}" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                  <img src="{{ asset('./assets/img/photo_2023-11-24_09-45-28.jpg') }}" class="d-block w-100" alt="...">
                </div>
              </div>
              ...
              <div class="row row-cols-2">
                <div class="col-md-6 my-1">
                  <div class="bg-primary p-2 rounded-3 info-card">
                    <a href="/wallet" class="d-flex flex-row justify-content-between text-decoration-none text-white">
                      <img src="{{ asset('./assets/img/wallet.svg') }}" class="img-fluid rounded-top" alt="">
                      <span>Wallet</span>
                    </a>
                  </div>
                </div>
                <div class="col-md-6 my-1">
                  <div class="bg-primary p-2 rounded-3 info-card">
                    <a href="#!" class="d-flex flex-row justify-content-between text-decoration-none text-white">
                      <img src="{{ asset('./assets/img/calendar.svg') }}" class="img-fluid rounded-top" alt="">
                      <span>Calendar</span>
                    </a>
                  </div>
                </div>
                ...
                <div class="col-md-6 my-1">
                  <div class="bg-primary p-2 rounded-3 info-card">
                    <a href="./pages/3d_history.html" class="d-flex flex-row justify-content-between text-decoration-none text-white">
